...
class Pub_and_Sub():
    ...
    def main(self):
        ...
        orien_const.orientation.x = .681
        # orien_const.orientation.y = 0.147;
        # orien_const.orientation.z = 0.708;
        # orien_const.orientation.w = -0.113;
        ...
        # while not rospy.is_shutdown():
            try:
                ...
                # #x, y, and z position
                goal_1.pose.position.x = trans_headcam_to_ar.transform.translation.x - 0.25 #PoseStamped.position.x
                goal_1.pose.position.y = trans_headcam_to_ar.transform.translation.y + 0.42 #PoseStamped.position.y
                goal_1.pose.position.z = trans_headcam_to_ar.transform.translation.z + 0.18 #PoseStamped.position.z
